    ...
    mapSvg.selectAll("path")
        ...
        .on("mouseover", function(d) {  
            navMap.transition()    
                .duration(200)    
                .style("opacity", .9);    
            navMap.html("<h6>" + d.properties.name + "</h6>"+ "<br/> <p class='text-danger'> Totales: "  + d.properties.totales + "</p>"
              +"<br/> <p class='text-warning'> Activos: "  + d.properties.activos + "</p>"+"<br/> <p class='text-primary'> Muertes: "  + d.properties.muertes + "</p>")  
